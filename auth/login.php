...
<head>
  <meta charset="UTF-8">
  <title>Login | Kompetisi Voli</title>
  ...
  <div class="row form-wrapper shadow-box bg-white rounded overflow-hidden">
    ...
    <div class="col-md-6 p-5">
      ...
      <div class="d-flex mb-3">
        <button class="btn btn-outline-primary me-2 active">Sign In</button>
        <a href="index.php?page=register" class="btn btn-outline-secondary">Signup</a>
      </div>

      <form action="index.php?page=plogin" method="POST">
        <div class="mb-3">
    ...
    <div class="col-md-6 bg-light d-none d-md-flex align-items-center justify-content-center">
      <img src="assets/img/safe.svg" alt="Ilustrasi Login" class="img-fluid" style="max-height: 350px;">
    </div>
  </div>
</div>
